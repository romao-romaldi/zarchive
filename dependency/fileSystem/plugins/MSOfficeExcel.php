...
/**
 * Class for Microsoft Excel conversion functions
 *
 * @package Dependency/fileSystem
 * @author  Arnaud PAUGET <arnaud.pauget@maarch.org>
 */
class MSOfficeExcel implements \dependency\fileSystem\conversionInterface
{
    ...
    public function convert($srcfile, $options = null)
    {
        ...
        $tokens[] = 'excel >> c:/temp/testExcel.log"';
